...
class VentanaLimites(ctk.CTkFrame):
    ...
    def _construir_cuerpo(self):
        ...
        ctk.CTkLabel(marco, text="Análisis Matemático y Tabla de Valores",
    ...
    def _construir_zona_defensa_y_grafica(self):
        ...
        panel_def.pack(side="left", fill="y", padx=(0, 8))
